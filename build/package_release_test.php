...
system("$systemGit fetch --tags upstream");
$gitSource = '6.0.0-alpha'; // 'upstream/6.x';
...
$deletedFiles = json_decode(file_get_contents(dirname(__DIR__).'/mautic-update/deleted_files.txt'), true);
